...
class Request extends Component
{
    ...
    /**
     *  TODO Проверили информацию. Для вашего аккаунта разрешена отправка от имени отправителя Test, вами было указано " originator=test" , в связи с чем сообщения было отбито. (имя регистрозависимо).
     *
     *
     * @var string
     */
